...
if __name__ == "__main__":
    ...
    run_scrape_enrich_batched(
        keyword="Sandal Wanita",                          # ganti kalau mau scraping lagi
        per_run_page_limit=1,                          # ambil 1 halaman (karena setiap run cuma dapat 1 page)
        out_csv="output/sandalWanita_enriched.csv",       # ini juga ganti
        state_path="output/state_sandalWanita.json",      # ini juga ganti
