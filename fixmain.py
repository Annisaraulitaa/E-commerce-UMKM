...
if __name__ == "__main__":
    ...
    run_scrape_enrich_batched(
        keyword="Personal Care",                          # ganti kalau mau scraping lagi
        per_run_page_limit=1,                          # ambil 1 halaman (karena setiap run cuma dapat 1 page)
        out_csv="output/personalCare_enriched.csv",       # ini juga ganti
        state_path="output/state_personalCare.json",      # ini juga ganti
