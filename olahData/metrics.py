...
def ndcg_at_k(labels, total_relevant, k):
    ...
    DCG memakai label manual pada hasil Top-K.
    IDCG memakai jumlah produk relevan dalam judged pool, dibatasi K.

    Ini lebih tepat daripada IDCG hanya dari label yang berhasil diretrieve,
    karena NDCG juga harus menghukum sistem yang gagal mengambil item relevan.
    """
