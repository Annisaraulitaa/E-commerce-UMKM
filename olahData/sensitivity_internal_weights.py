    ...
    for sold_w, review_w in POPULARITY_WEIGHT_CANDIDATES:
        ...
        for q in TEST_QUERIES:
            ...
            rows.append({
                ...
                "Precision@20": precision_at_k(hybrid_res, q, TOP_K),
                "Recall@20": recall_at_k(hybrid_res, candidate_pool, q, TOP_K),
                "NDCG@20": ndcg_at_k(hybrid_res, TOP_K),
                "Fairness@20": fairness_at_k(hybrid_res, TOP_K),
                "ExposureDisparity@20": exposure_disparity_at_k(hybrid_res, TOP_K),
            })
